...
DEFAULT_RUN_STATUS = r"""\Data\Results Summary\Run-Status\Output\UOSSTAT
...
def load_example():
    ...
    st.session_state.output_dir = r"C:\project\results"
    st.session_state.h2_path = r"\Data\Streams\SH2\Input\FLOW"
    st.session_state.output_variables = r"""Methanol_prod_mol_h=\Data\Streams\CRUDEMEO\Output\MOLEFLOW\MIXED\METHANOL
...
with col_top_1:
    if st.button("Load sample configuration"):
        ...
        st.rerun()
with col_top_2:
    st.info(r"Paste only Aspen internal paths such as \Data\Streams\... Do not paste Application.Tree.FindNode(...).")
